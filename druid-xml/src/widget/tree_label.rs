...
impl<T: EditableText + TextStorage> TreeLabel<T> {
...
impl<T: TextStorage + EditableText> TreeLabel<T> {
...
impl<T: TextStorage + EditableText> Widget<T> for TreeLabel<T> {
...
impl<T: TextStorage + EditableText> Default for TreeLabel<T> {
    fn default() -> Self {
        TreeLabel::new()
    }
}
